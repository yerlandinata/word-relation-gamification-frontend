...
/* harmony import */ var _components_AnnotationDetail__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./components/AnnotationDetail */ "./modules/Annotation/components/AnnotationDetail.jsx");
/* harmony import */ var _reducer__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./reducer */ "./modules/Annotation/reducer.js");
...
function (_React$Component) {
  Object(_babel_runtime_corejs2_helpers_esm_inherits__WEBPACK_IMPORTED_MODULE_6__["default"])(AnnotationList, _React$Component);

  function AnnotationList(props) {
    var _this;

    Object(_babel_runtime_corejs2_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_1__["default"])(this, AnnotationList);

    _this = Object(_babel_runtime_corejs2_helpers_esm_possibleConstructorReturn__WEBPACK_IMPORTED_MODULE_3__["default"])(this, Object(_babel_runtime_corejs2_helpers_esm_getPrototypeOf__WEBPACK_IMPORTED_MODULE_4__["default"])(AnnotationList).call(this, props));
    _this._createAnnotationDescription = _this._createAnnotationDescription.bind(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_5__["default"])(_this));
    return _this;
  }

  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(AnnotationList, [{
    key: "render",
    value: function render() {
      var _this2 = this;

      return this.props.isLoading ? __jsx(_shared_Center__WEBPACK_IMPORTED_MODULE_9__["default"], {
        __source: {
          fileName: _jsxFileName,
          lineNumber: 15
        },
        __self: this
      }, "loading..") : __jsx(_shared_Center__WEBPACK_IMPORTED_MODULE_9__["default"], {
        ...
        __self: this
      }, this.props.wordRelationTypes.map(function (wrt, i) {
        return __jsx("div", {
          key: i,
          className: "m-2",
          __source: {
          ...
          __self: this
        }, __jsx(_components_AnnotationDetail__WEBPACK_IMPORTED_MODULE_10__["default"], {
          desc: _this2._createAnnotationDescription(wrt.description),
          onSubmitLowConfidence: _this2._createLowConfidenceSubmissionHandler(wrt.id),
          onSubmitHighConfidence: _this2._createHighConfidenceSubmissionHandler(wrt.id),
          __source: {
            fileName: _jsxFileName,
            lineNumber: 20
          },
    ...
    key: "_createAnnotationDescription",
    value: function _createAnnotationDescription(desc) {
      return desc.replace(/\%a/g, this.props.wordPair.word1).replace(/\%b/g, this.props.wordPair.word2);
    }
  }, {
    key: "_createLowConfidenceSubmissionHandler",
    value: function _createLowConfidenceSubmissionHandler(wrtId) {
      var _this3 = this;

      return function () {
        return _this3.props.submitLowConfidence(_this3.props.wordPair.id, wrtId);
      };
    }
  }, {
    key: "_createHighConfidenceSubmissionHandler",
    value: function _createHighConfidenceSubmissionHandler(wrtId) {
      var _this4 = this;

      return function () {
        return _this4.props.submitHighConfidence(_this4.props.wordPair.id, wrtId);
      };
    }
  }]);
...
var mapStateToProps = function mapStateToProps(state) {
  return Object(_babel_runtime_corejs2_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_0__["default"])({}, state.annotationState, {
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    submitLowConfidence: function submitLowConfidence(wordPairId, wrtId) {
      return dispatch(Object(_reducer__WEBPACK_IMPORTED_MODULE_11__["postAnnotation"])(wordPairId, wrtId, false));
    },
    submitHighConfidence: function submitHighConfidence(wordPairId, wrtId) {
      return dispatch(Object(_reducer__WEBPACK_IMPORTED_MODULE_11__["postAnnotation"])(wordPairId, wrtId, true));
    }
  };
};

var AnnotationListConnected = Object(react_redux__WEBPACK_IMPORTED_MODULE_8__["connect"])(mapStateToProps, mapDispatchToProps)(AnnotationList);
...
var POST_LOGIN = 'Login/POST';
var POST_LOGIN_SUCCESS = 'Login/POST_SUCCESS';
var POST_LOGIN_FAILURE = 'Login/POST_FAILURE';
var postLogin = function postLogin(phoneNumber, birthDate) {
  return {
    type: POST_LOGIN,
    payload: {
...
var postLoginSuccess = function postLoginSuccess(isNewUser) {
  return {
...
var postLoginFailure = function postLoginFailure(error) {
  return {
...
var desc = '%a adalah sejenis %b';

var WordPair = function WordPair(_ref) {
  var word1 = _ref.word1,
      word2 = _ref.word2,
      example = _ref.example,
      isLoading = _ref.isLoading;
  return isLoading ? __jsx(_shared_Center__WEBPACK_IMPORTED_MODULE_4__["default"], {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 13
    },
...
var mapStateToProps = function mapStateToProps(state) {
  return Object(_babel_runtime_corejs2_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_0__["default"])({}, state.wordPairState);
};

var WordPairConnected = Object(react_redux__WEBPACK_IMPORTED_MODULE_2__["connect"])(mapStateToProps)(WordPair);
...
/*#__PURE__*/
function (_React$Component) {
  Object(_babel_runtime_corejs2_helpers_esm_inherits__WEBPACK_IMPORTED_MODULE_5__["default"])(WordPairExample, _React$Component);

  function WordPairExample(props) {
    var _this;

    Object(_babel_runtime_corejs2_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_0__["default"])(this, WordPairExample);

    _this = Object(_babel_runtime_corejs2_helpers_esm_possibleConstructorReturn__WEBPACK_IMPORTED_MODULE_2__["default"])(this, Object(_babel_runtime_corejs2_helpers_esm_getPrototypeOf__WEBPACK_IMPORTED_MODULE_3__["default"])(WordPairExample).call(this, props));
    _this.state = {
      isShowing: false
    };
    _this._onShowHintClick = _this._onShowHintClick.bind(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_4__["default"])(_this));
    return _this;
  }

  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(WordPairExample, [{
    key: "render",
    value: function render() {
    ...
    value: function _onShowHintClick() {
      this.setState({
        isShowing: true
      });
    }
...
var Center = function Center(_ref) {
  ...
  return __jsx("div", {
    className: "d-flex flex-row justify-content-center ".concat(className),
    __source: {
      fileName: _jsxFileName,
      lineNumber: 4
    },
...
/***/ "./node_modules/next/dist/build/webpack/loaders/next-client-pages-loader.js?page=%2F&absolutePagePath=C%3A%5CUsers%5Cyerla%5CUI%5CSemester7%5CTACodes%5Cword-relation-gamification-frontend%5Cpages%5Cindex.jsx!./":
/*!**********************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/next/dist/build/webpack/loaders/next-client-pages-loader.js?page=%2F&absolutePagePath=C%3A%5CUsers%5Cyerla%5CUI%5CSemester7%5CTACodes%5Cword-relation-gamification-frontend%5Cpages%5Cindex.jsx ***!
  \**********************************************************************************************************************************************************************************************************************/
/*! no static exports found */
...
var Index = function Index() {
  return __jsx(_modules_MainPage_MainPage__WEBPACK_IMPORTED_MODULE_1__["default"], {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 5
    },
...
/***/ 0:
/*!**************************************************************************************************************************************************************************!*\
  !*** multi next-client-pages-loader?page=%2F&absolutePagePath=C%3A%5CUsers%5Cyerla%5CUI%5CSemester7%5CTACodes%5Cword-relation-gamification-frontend%5Cpages%5Cindex.jsx ***!
  \**************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! next-client-pages-loader?page=%2F&absolutePagePath=C%3A%5CUsers%5Cyerla%5CUI%5CSemester7%5CTACodes%5Cword-relation-gamification-frontend%5Cpages%5Cindex.jsx! */"./node_modules/next/dist/build/webpack/loaders/next-client-pages-loader.js?page=%2F&absolutePagePath=C%3A%5CUsers%5Cyerla%5CUI%5CSemester7%5CTACodes%5Cword-relation-gamification-frontend%5Cpages%5Cindex.jsx!./");
