...
export const updateUserInfo = ({token, phoneNumber, displayName, score, rank, elapsedTime, level}) => ({
    type: UPDATE_USER_INFO,
    payload: {token, phoneNumber, displayName, score, rank, elapsedTime, level}
})
