...
export const updateUserInfo = ({token, phoneNumber, birthDate, displayName, score, rank, elapsedTime, level}) => ({
    type: UPDATE_USER_INFO,
    payload: {token, phoneNumber, birthDate, displayName, score, rank, elapsedTime, level}
})
